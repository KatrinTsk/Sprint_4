...
public class OrderTest {
    ...
    static Stream<Arguments> orderFormFirst() {
        return Stream.of(
                ...
                Arguments.of(false, "Александр", "Пушкин", "пер. Вернадского, 21", "Румянцево", "79137654321", "17.05.2025", "семеро суток", "grey", "Тест 2"),
                Arguments.of(false, "Сергей", "Есенин", "ул. Студенческая, 23", "Царицыно", "89231112233", "17.05.2025", "трое суток", "black", "Тест 3"),
                Arguments.of(true, "Марина", "Цветаева", "пер. Столешников, 7", "Лубянка", "79523332211", "17.05.2025", "пятеро суток", "grey", "Тест 4")
        );
    }
}
